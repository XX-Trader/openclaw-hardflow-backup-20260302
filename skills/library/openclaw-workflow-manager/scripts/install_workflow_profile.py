...
def build_cron_setup_cmd(
    *,
    ...
    cmd = [
        ...
        "--install-upgrade-feedback-job",
        "--upgrade-feedback-py",
        str(Path(ops_home) / "upgrade_feedback_runner.py"),
        "--upgrade-feedback-executor-run-dir",
        str(Path(ops_home) / "task-center/executor-runs"),
        "--upgrade-feedback-output-dir",
        str(Path(ops_home) / "upgrade-feedback/reports"),
        "--upgrade-feedback-state",
        str(Path(ops_home) / "upgrade-feedback/state.json"),
        "--upgrade-feedback-workflow-profile-registry",
        str(Path(ops_home) / "policy/workflow-profile-registry.json"),
        "--upgrade-feedback-benchmark-suite-file",
        str(Path(ops_home) / "policy/benchmark-suite-registry.json"),
        "--upgrade-feedback-benchmark-suite-id",
        "coding-default-core",
        "--upgrade-feedback-every-ms",
        "86400000",
        "--upgrade-feedback-log-mode",
        "silent",
        "--upgrade-feedback-workflow-target",
        "task_executor_10m",
        "--upgrade-feedback-skill-name",
        "openclaw-evolution-upgrader",
        "--upgrade-feedback-skill-assignee",
        "optimization-agent",
        "--upgrade-feedback-baseline-count",
        "3",
        "--upgrade-feedback-candidate-count",
        "3",
        "--upgrade-feedback-task-db",
        task_db,
        "--upgrade-feedback-auto-create-tasks",
        "--upgrade-feedback-auto-apply-workflow-promotion",
        "--upgrade-feedback-promotion-operator",
        "cron-upgrade-feedback",
        "--upgrade-feedback-task-score-threshold",
        "80.0",
        "--upgrade-feedback-task-schedule-gap-minutes",
        "120",
        "--install-benchmark-sweep-job",
        "--benchmark-sweep-py",
        str(Path(ops_home) / "benchmark_orchestrator.py"),
        "--benchmark-sweep-executor-run-dir",
        str(Path(ops_home) / "task-center/executor-runs"),
        "--benchmark-sweep-output-root",
        str(Path(ops_home) / "benchmark-sweeps"),
        "--benchmark-sweep-state-root",
        str(Path(ops_home) / "benchmark-sweeps/state"),
        "--benchmark-sweep-output-py",
        str(Path(ops_home) / "benchmark_output_consumer.py"),
        "--benchmark-sweep-summary-file",
        str(Path(ops_home) / "benchmark-sweeps/sweeps/latest-summary.json"),
        "--benchmark-sweep-consumer-output-file",
        str(Path(ops_home) / "benchmark-sweeps/output/latest-event.json"),
        "--benchmark-sweep-consumer-notify-on",
        "error",
        "--benchmark-sweep-benchmark-suite-file",
        str(Path(ops_home) / "policy/benchmark-suite-registry.json"),
        "--benchmark-sweep-workflow-profile-registry",
        str(Path(ops_home) / "policy/workflow-profile-registry.json"),
        "--benchmark-sweep-task-db",
        task_db,
        "--benchmark-sweep-every-ms",
        "86400000",
        "--benchmark-sweep-log-mode",
        "silent",
        "--no-benchmark-sweep-auto-create-tasks",
        "--no-benchmark-sweep-auto-apply-workflow-promotion",
        "--benchmark-sweep-promotion-operator",
        "cron-benchmark-sweep",
        "--benchmark-sweep-task-score-threshold",
        "80.0",
        "--benchmark-sweep-task-schedule-gap-minutes",
        "120",
        "--benchmark-sweep-suite-id",
        "coding-default-core",
        "--benchmark-sweep-suite-id",
        "research-default-core",
        "--benchmark-sweep-suite-id",
        "docs-default-core",
        "--benchmark-sweep-suite-id",
        "ops-default-core",
        "--install-benchmark-output-job",
        "--benchmark-output-py",
        str(Path(ops_home) / "benchmark_output_consumer.py"),
        "--benchmark-output-summary-file",
        str(Path(ops_home) / "benchmark-sweeps/sweeps/latest-summary.json"),
        "--benchmark-output-output-file",
        str(Path(ops_home) / "benchmark-sweeps/output/latest-event.json"),
        "--benchmark-output-notify-on",
        "error",
        "--benchmark-output-every-ms",
        "86400000",
        "--benchmark-output-delay-ms",
        "300000",
        "--install-task-output-broadcast-job",
        "--task-output-broadcast-py",
        str(Path(ops_home) / "task_output_broadcast_runner.py"),
        "--task-output-broadcast-db",
        task_db,
        "--task-output-broadcast-state",
        str(Path(ops_home) / "task-output/state.json"),
        "--task-output-broadcast-output",
        str(Path(ops_home) / "task-output/latest-event.json"),
        "--task-output-broadcast-lookback-hours",
        "24",
        "--task-output-broadcast-limit",
        "12",
        "--task-output-broadcast-event-limit",
        "200",
        "--task-output-broadcast-notify-on",
        "error",
        "--task-output-broadcast-every-ms",
        "900000",
        "--task-output-broadcast-delay-ms",
        "120000",
        "--install-control-plane-summary-job",
        "--control-plane-summary-py",
        str(Path(ops_home) / "control_plane_summary_runner.py"),
        "--control-plane-summary-db",
        task_db,
        "--control-plane-summary-state",
        str(Path(ops_home) / "control-plane-summary/state.json"),
        "--control-plane-summary-output",
        str(Path(ops_home) / "control-plane-summary/latest-event.json"),
        "--control-plane-summary-lookback-hours",
        "24",
        "--control-plane-summary-limit",
        "20",
        "--control-plane-summary-notify-on",
        "activity",
        "--control-plane-summary-every-ms",
        "21600000",
        "--control-plane-summary-delay-ms",
        "180000",
        "--install-control-plane-dashboard-job",
        "--control-plane-dashboard-py",
        str(Path(ops_home) / "control_plane_dashboard.py"),
        "--control-plane-dashboard-db",
        task_db,
        "--control-plane-dashboard-benchmark-summary-file",
        str(Path(ops_home) / "benchmark-sweeps/sweeps/latest-summary.json"),
        "--control-plane-dashboard-json-output",
        str(Path(ops_home) / "control-plane-dashboard/latest-dashboard.json"),
        "--control-plane-dashboard-markdown-output",
        str(Path(ops_home) / "control-plane-dashboard/latest-dashboard.md"),
        "--control-plane-dashboard-html-output",
        str(Path(ops_home) / "control-plane-dashboard/latest-dashboard.html"),
        "--control-plane-dashboard-lookback-hours",
        "24",
        "--control-plane-dashboard-limit",
        "20",
        "--control-plane-dashboard-every-ms",
        "21600000",
        "--control-plane-dashboard-delay-ms",
        "240000",
        "--install-control-plane-optimization-job",
        "--control-plane-optimization-py",
        str(Path(ops_home) / "control_plane_optimization_advisor.py"),
        "--control-plane-optimization-db",
        task_db,
        "--control-plane-optimization-json-output",
        str(Path(ops_home) / "control-plane-optimization/latest-report.json"),
        "--control-plane-optimization-markdown-output",
        str(Path(ops_home) / "control-plane-optimization/latest-report.md"),
        "--control-plane-optimization-lookback-hours",
        "24",
        "--control-plane-optimization-limit",
        "20",
        "--control-plane-optimization-every-ms",
        "43200000",
        "--control-plane-optimization-delay-ms",
        "360000",
        "--install-control-plane-optimization-dispatch-job",
        "--control-plane-optimization-dispatch-py",
        str(Path(ops_home) / "control_plane_optimization_dispatcher.py"),
        "--control-plane-optimization-dispatch-report-file",
        str(Path(ops_home) / "control-plane-optimization/latest-report.json"),
        "--control-plane-optimization-dispatch-task-db",
        task_db,
        "--control-plane-optimization-dispatch-json-output",
        str(Path(ops_home) / "control-plane-optimization-dispatch/latest-report.json"),
        "--control-plane-optimization-dispatch-markdown-output",
        str(Path(ops_home) / "control-plane-optimization-dispatch/latest-report.md"),
        "--control-plane-optimization-dispatch-execution-workflow-profile",
        "coding-default",
        "--control-plane-optimization-dispatch-execution-workflow-channel",
        "stable",
        "--control-plane-optimization-dispatch-schedule-gap-minutes",
        "30",
        "--control-plane-optimization-dispatch-every-ms",
        "43200000",
        "--control-plane-optimization-dispatch-delay-ms",
        "480000",
        "--install-control-plane-optimization-review-job",
        "--control-plane-optimization-review-py",
        str(Path(ops_home) / "control_plane_optimization_review_runner.py"),
        "--control-plane-optimization-review-task-db",
        task_db,
        "--control-plane-optimization-review-json-output",
        str(Path(ops_home) / "control-plane-optimization-review/latest-report.json"),
        "--control-plane-optimization-review-markdown-output",
        str(Path(ops_home) / "control-plane-optimization-review/latest-report.md"),
        "--control-plane-optimization-review-lookback-hours",
        "72",
        "--control-plane-optimization-review-limit",
        "20",
        "--control-plane-optimization-review-every-ms",
        "43200000",
        "--control-plane-optimization-review-delay-ms",
        "540000",
        "--install-control-plane-profile-update-dispatch-job",
        "--control-plane-profile-update-dispatch-py",
        str(Path(ops_home) / "control_plane_profile_update_dispatcher.py"),
        "--control-plane-profile-update-dispatch-review-file",
        str(Path(ops_home) / "control-plane-optimization-review/latest-report.json"),
        "--control-plane-profile-update-dispatch-task-db",
        task_db,
        "--control-plane-profile-update-dispatch-json-output",
        str(Path(ops_home) / "control-plane-profile-update-dispatch/latest-report.json"),
        "--control-plane-profile-update-dispatch-markdown-output",
        str(Path(ops_home) / "control-plane-profile-update-dispatch/latest-report.md"),
        "--control-plane-profile-update-dispatch-execution-workflow-profile",
        "coding-default",
        "--control-plane-profile-update-dispatch-execution-workflow-channel",
        "stable",
        "--control-plane-profile-update-dispatch-schedule-gap-minutes",
        "60",
        "--control-plane-profile-update-dispatch-every-ms",
        "43200000",
        "--control-plane-profile-update-dispatch-delay-ms",
        "600000",
        "--install-control-plane-profile-update-apply-job",
        "--control-plane-profile-update-apply-py",
        str(Path(ops_home) / "control_plane_profile_update_applier.py"),
        "--control-plane-profile-update-apply-task-db",
        task_db,
        "--control-plane-profile-update-apply-registry-file",
        str(Path(ops_home) / "policy/workflow-profile-registry.json"),
        "--control-plane-profile-update-apply-json-output",
        str(Path(ops_home) / "control-plane-profile-update-apply/latest-report.json"),
        "--control-plane-profile-update-apply-markdown-output",
        str(Path(ops_home) / "control-plane-profile-update-apply/latest-report.md"),
        "--control-plane-profile-update-apply-target-channel",
        "candidate",
        "--control-plane-profile-update-apply-lookback-hours",
        "72",
        "--control-plane-profile-update-apply-limit",
        "20",
        "--control-plane-profile-update-apply-every-ms",
        "43200000",
        "--control-plane-profile-update-apply-delay-ms",
        "660000",
        "--install-control-plane-profile-update-validation-job",
        "--control-plane-profile-update-validation-py",
        str(Path(ops_home) / "control_plane_profile_update_validation_runner.py"),
        "--control-plane-profile-update-validation-apply-file",
        str(Path(ops_home) / "control-plane-profile-update-apply/latest-report.json"),
        "--control-plane-profile-update-validation-benchmark-suite-file",
        str(Path(ops_home) / "policy/benchmark-suite-registry.json"),
        "--control-plane-profile-update-validation-executor-run-dir",
        str(Path(ops_home) / "task-center/executor-runs"),
        "--control-plane-profile-update-validation-output-root",
        str(Path(ops_home) / "control-plane-profile-update-validation"),
        "--control-plane-profile-update-validation-state-file",
        str(Path(ops_home) / "control-plane-profile-update-validation/state.json"),
        "--control-plane-profile-update-validation-task-db",
        task_db,
        "--control-plane-profile-update-validation-workflow-profile-registry",
        str(Path(ops_home) / "policy/workflow-profile-registry.json"),
        "--control-plane-profile-update-validation-json-output",
        str(Path(ops_home) / "control-plane-profile-update-validation/latest-report.json"),
        "--control-plane-profile-update-validation-markdown-output",
        str(Path(ops_home) / "control-plane-profile-update-validation/latest-report.md"),
        "--control-plane-profile-update-validation-every-ms",
        "43200000",
        "--control-plane-profile-update-validation-delay-ms",
        "720000",
        "--install-control-plane-acceptance-job",
        "--control-plane-acceptance-py",
        str(Path(ops_home) / "control_plane_acceptance_runner.py"),
        "--control-plane-acceptance-jobs-file",
        jobs_file,
        "--control-plane-acceptance-json-output",
        str(Path(ops_home) / "control-plane-acceptance/latest-report.json"),
        "--control-plane-acceptance-markdown-output",
        str(Path(ops_home) / "control-plane-acceptance/latest-report.md"),
        "--control-plane-acceptance-every-ms",
        "43200000",
        "--control-plane-acceptance-delay-ms",
        "420000",
        "--install-control-plane-live-acceptance-job",
        "--control-plane-live-acceptance-py",
        str(Path(ops_home) / "control_plane_live_acceptance_runner.py"),
        "--control-plane-live-acceptance-workspace-root",
        str(Path(ops_home) / "control-plane-live-acceptance"),
        "--control-plane-live-acceptance-jobs-file",
        jobs_file,
        "--control-plane-live-acceptance-json-output",
        str(Path(ops_home) / "control-plane-live-acceptance/latest-report.json"),
        "--control-plane-live-acceptance-markdown-output",
        str(Path(ops_home) / "control-plane-live-acceptance/latest-report.md"),
        "--control-plane-live-acceptance-lookback-hours",
        "24",
        "--control-plane-live-acceptance-limit",
        "20",
        "--control-plane-live-acceptance-every-ms",
        "86400000",
        "--control-plane-live-acceptance-delay-ms",
        "540000",
...
def main() -> None:
    ...
    multi_project_governance_cmds = [
        (
            ...
            build_install_multi_project_governance_cmd(
                ...
                auto_pr= False if bool(item.get("external_readonly", False)) else resolve_optional_bool(
    ...
    multi_project_auto_update_cmds = [
        ...
        for item in multi_project_targets
        if (
            not bool(item.get("external_readonly", False))
            and (
                str(item.get("auto_update_install_cmd", "")).strip()
                or format_install_cmd_template(auto_update_template, item)
            )
