...
DEFAULT_POLICY: dict[str, Any] = {
    ...
    "agent_model_overrides": {
        ...
        "agent-factory": "openai-codex/gpt-5.3-codex-spark",
        "backend-dev": "openai-codex/gpt-5.3-codex-spark",
        "frontend-dev": "openai-codex/gpt-5.3-codex-spark",
        "optimization-agent": "openai-codex/gpt-5.3-codex-spark",
        "project-agent": "openai-codex/gpt-5.3-codex-spark",
