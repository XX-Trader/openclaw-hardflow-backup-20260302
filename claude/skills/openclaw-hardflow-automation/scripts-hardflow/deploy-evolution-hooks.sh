...
deploy_one() {
  ...
  "${SSH_BIN}" -F "${SSH_CONFIG}" "${alias}" "chmod +x ~/.openclaw/hardflow-hooks/tools/experience-maintain-cron.sh ~/.openclaw/hardflow-hooks/tools/remote-install-maintenance-cron.sh"
