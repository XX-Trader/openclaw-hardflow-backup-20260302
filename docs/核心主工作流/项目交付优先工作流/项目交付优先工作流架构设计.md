...
| `solution_review` | 双 AI 对抗式审查交付计划 | `solution_review.md` + `command_solution_review_1/2.json` | 两条不同命令、不同 `reviewer_role` 的 reviewer command 均先审 `delivery_plan.json` 并裁决 `ready_for_implement` |
